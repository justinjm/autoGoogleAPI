...
#'  at 2021-04-16 10:01:22
#' filename: /Users/justin/dev/R/autoGoogleAPI/googleautomlv1beta1.auto/R/automl_functions.R
#' api_json: api_json
#' 
#' @details 
...
#' @importFrom googleAuthR gar_api_generator
#' @export
projects.locations.operations.list <- function(name, filter = NULL, pageSize = NULL, 
    pageToken = NULL) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
projects.locations.datasets.tableSpecs.list <- function(parent, filter = NULL, fieldMask = NULL, 
    ...
    pars = list(filter = filter, fieldMask = fieldMask, pageSize = pageSize, pageToken = pageToken)
    f <- googleAuthR::gar_api_generator(url, "GET", pars_args = rmNullObs(pars), 
        data_parse_function = function(x) x)
    f()
...
projects.locations.datasets.tableSpecs.columnSpecs.list <- function(parent, pageSize = NULL, 
    fieldMask = NULL, filter = NULL, pageToken = NULL) {
    ...
    pars = list(pageSize = pageSize, fieldMask = fieldMask, filter = filter, pageToken = pageToken)
    f <- googleAuthR::gar_api_generator(url, "GET", pars_args = rmNullObs(pars), 
        data_parse_function = function(x) x)
    f()
