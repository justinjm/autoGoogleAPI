...
#'  at 2019-07-03 22:24:43
#' filename: /Users/justin/Dropbox/dev/R/autoGoogleAPI/googleautomlv1beta1.auto/R/automl_objects.R
#' api_json: api_json
#' 
...
#' @export
TableSpec <- function(name = NULL, timeColumnSpecId = NULL, columnCount = NULL, inputConfigs = NULL, 
    rowCount = NULL, etag = NULL) {
    structure(list(name = name, timeColumnSpecId = timeColumnSpecId, columnCount = columnCount, 
        inputConfigs = inputConfigs, rowCount = rowCount, etag = etag), class = "gar_TableSpec")
}
...
#' @details 
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_objects}}
#' Additional domain-specific parameters, any string must be up to 25000characters long.*  For Image Classification:   `score_threshold` - (float) A value from 0.0 to 1.0. When the model    makes predictions for an image, it will only produce results that have    at least this confidence score. The default is 0.5. *  For Image Object Detection:   `score_threshold` - (float) When Model detects objects on the image,       it will only produce bounding boxes which have at least this       confidence score. Value in 0 to 1 range, default is 0.5.   `max_bounding_box_count` - (int64) No more than this number of bounding       boxes will be returned in the response. Default is 100, the       requested value may be limited by server.*  For Tables:   `feature_importance` - (boolean) Whetherfeature_importance       should be populated in the returnedTablesAnnotation(-s).       The default is false.
#' 
#' 
#' 
...
#' @export
ColumnSpec <- function(etag = NULL, dataType = NULL, name = NULL, topCorrelatedColumns = NULL, 
    dataStats = NULL, displayName = NULL) {
    structure(list(etag = etag, dataType = dataType, name = name, topCorrelatedColumns = topCorrelatedColumns, 
        dataStats = dataStats, displayName = displayName), class = "gar_ColumnSpec")
}
...
#' @export
PredictResponse <- function(PredictResponse.metadata = NULL, metadata = NULL, payload = NULL) {
    structure(list(PredictResponse.metadata = PredictResponse.metadata, metadata = metadata, 
        payload = payload), class = "gar_PredictResponse")
}
...
DataStats <- function(stringStats = NULL, arrayStats = NULL, structStats = NULL, 
    categoryStats = NULL, distinctValueCount = NULL, validValueCount = NULL, nullValueCount = NULL, 
    float64Stats = NULL, timestampStats = NULL) {
    structure(list(stringStats = stringStats, arrayStats = arrayStats, structStats = structStats, 
        categoryStats = categoryStats, distinctValueCount = distinctValueCount, validValueCount = validValueCount, 
        nullValueCount = nullValueCount, float64Stats = float64Stats, timestampStats = timestampStats), 
        class = "gar_DataStats")
}
...
#' @export
ClassificationEvaluationMetrics <- function(auRoc = NULL, baseAuPrc = NULL, annotationSpecId = NULL, 
    logLoss = NULL, auPrc = NULL, confusionMatrix = NULL, confidenceMetricsEntry = NULL) {
    structure(list(auRoc = auRoc, baseAuPrc = baseAuPrc, annotationSpecId = annotationSpecId, 
        logLoss = logLoss, auPrc = auPrc, confusionMatrix = confusionMatrix, confidenceMetricsEntry = confidenceMetricsEntry), 
...
#' @export
ImageClassificationModelMetadata <- function(modelType = NULL, trainBudget = NULL, 
    trainCost = NULL, stopReason = NULL, baseModelId = NULL) {
    structure(list(modelType = modelType, trainBudget = trainBudget, trainCost = trainCost, 
        stopReason = stopReason, baseModelId = baseModelId), class = "gar_ImageClassificationModelMetadata")
}
...
ImageObjectDetectionModelMetadata <- function(modelType = NULL, trainBudgetMilliNodeHours = NULL, 
    stopReason = NULL, nodeQps = NULL, trainCostMilliNodeHours = NULL, nodeCount = NULL) {
    structure(list(modelType = modelType, trainBudgetMilliNodeHours = trainBudgetMilliNodeHours, 
        ...
        nodeCount = nodeCount), class = "gar_ImageObjectDetectionModelMetadata")
}
...
#' @export
HistogramBucket <- function(min = NULL, max = NULL, count = NULL) {
    structure(list(min = min, max = max, count = count), class = "gar_HistogramBucket")
}
...
#' @export
Expr <- function(title = NULL, location = NULL, description = NULL, expression = NULL) {
    structure(list(title = title, location = location, description = description, 
        expression = expression), class = "gar_Expr")
}
...
#' @export
TablesModelMetadata <- function(tablesModelColumnInfo = NULL, inputFeatureColumnSpecs = NULL, 
    trainBudgetMilliNodeHours = NULL, disableEarlyStopping = NULL, trainCostMilliNodeHours = NULL, 
    targetColumnSpec = NULL, optimizationObjective = NULL) {
    structure(list(tablesModelColumnInfo = tablesModelColumnInfo, inputFeatureColumnSpecs = inputFeatureColumnSpecs, 
        trainBudgetMilliNodeHours = trainBudgetMilliNodeHours, disableEarlyStopping = disableEarlyStopping, 
        trainCostMilliNodeHours = trainCostMilliNodeHours, targetColumnSpec = targetColumnSpec, 
...
#' @export
VideoObjectTrackingAnnotation <- function(timeOffset = NULL, score = NULL, instanceId = NULL, 
    boundingBox = NULL) {
    structure(list(timeOffset = timeOffset, score = score, instanceId = instanceId, 
...
#' @export
AnnotationPayload <- function(translation = NULL, textSentiment = NULL, videoObjectTracking = NULL, 
    tables = NULL, annotationSpecId = NULL, videoClassification = NULL, classification = NULL, 
    textExtraction = NULL, imageObjectDetection = NULL, displayName = NULL) {
    structure(list(translation = translation, textSentiment = textSentiment, videoObjectTracking = videoObjectTracking, 
        tables = tables, annotationSpecId = annotationSpecId, videoClassification = videoClassification, 
        classification = classification, textExtraction = textExtraction, imageObjectDetection = imageObjectDetection, 
        displayName = displayName), class = "gar_AnnotationPayload")
}
...
#' @export
TextSentimentEvaluationMetrics <- function(annotationSpecId = NULL, linearKappa = NULL, 
    f1Score = NULL, meanSquaredError = NULL, precision = NULL, confusionMatrix = NULL, 
    quadraticKappa = NULL, meanAbsoluteError = NULL, recall = NULL) {
    structure(list(annotationSpecId = annotationSpecId, linearKappa = linearKappa, 
        f1Score = f1Score, meanSquaredError = meanSquaredError, precision = precision, 
        confusionMatrix = confusionMatrix, quadraticKappa = quadraticKappa, meanAbsoluteError = meanAbsoluteError, 
        recall = recall), class = "gar_TextSentimentEvaluationMetrics")
}
...
ClassificationEvaluationMetricsConfidenceMetricsEntry <- function(trueNegativeCount = NULL, 
    positionThreshold = NULL, falseNegativeCount = NULL, falsePositiveCount = NULL, 
    ...
    confidenceThreshold = NULL, f1Score = NULL) {
    structure(list(trueNegativeCount = trueNegativeCount, positionThreshold = positionThreshold, 
        ...
        precisionAt1 = precisionAt1, confidenceThreshold = confidenceThreshold, f1Score = f1Score), 
...
#' @export
Model <- function(name = NULL, translationModelMetadata = NULL, videoClassificationModelMetadata = NULL, 
    displayName = NULL, deploymentState = NULL, imageClassificationModelMetadata = NULL, 
    createTime = NULL, updateTime = NULL, textExtractionModelMetadata = NULL, tablesModelMetadata = NULL, 
    textClassificationModelMetadata = NULL, datasetId = NULL, imageObjectDetectionModelMetadata = NULL, 
    textSentimentModelMetadata = NULL, videoObjectTrackingModelMetadata = NULL) {
    structure(list(name = name, translationModelMetadata = translationModelMetadata, 
        videoClassificationModelMetadata = videoClassificationModelMetadata, displayName = displayName, 
        deploymentState = deploymentState, imageClassificationModelMetadata = imageClassificationModelMetadata, 
        createTime = createTime, updateTime = updateTime, textExtractionModelMetadata = textExtractionModelMetadata, 
        tablesModelMetadata = tablesModelMetadata, textClassificationModelMetadata = textClassificationModelMetadata, 
        datasetId = datasetId, imageObjectDetectionModelMetadata = imageObjectDetectionModelMetadata, 
        textSentimentModelMetadata = textSentimentModelMetadata, videoObjectTrackingModelMetadata = videoObjectTrackingModelMetadata), 
        class = "gar_Model")
}
...
ModelExportOutputConfig <- function(ModelExportOutputConfig.params = NULL, params = NULL, 
    gcsDestination = NULL, gcrDestination = NULL, modelFormat = NULL) {
    structure(list(ModelExportOutputConfig.params = ModelExportOutputConfig.params, 
        params = params, gcsDestination = gcsDestination, gcrDestination = gcrDestination, 
        modelFormat = modelFormat), class = "gar_ModelExportOutputConfig")
}
...
#' @export
ModelEvaluation <- function(createTime = NULL, annotationSpecId = NULL, imageObjectDetectionEvaluationMetrics = NULL, 
    textExtractionEvaluationMetrics = NULL, regressionEvaluationMetrics = NULL, name = NULL, 
    evaluatedExampleCount = NULL, videoObjectTrackingEvaluationMetrics = NULL, textSentimentEvaluationMetrics = NULL, 
    translationEvaluationMetrics = NULL, classificationEvaluationMetrics = NULL, 
    displayName = NULL) {
    structure(list(createTime = createTime, annotationSpecId = annotationSpecId, 
        ...
        name = name, evaluatedExampleCount = evaluatedExampleCount, videoObjectTrackingEvaluationMetrics = videoObjectTrackingEvaluationMetrics, 
        textSentimentEvaluationMetrics = textSentimentEvaluationMetrics, translationEvaluationMetrics = translationEvaluationMetrics, 
        classificationEvaluationMetrics = classificationEvaluationMetrics, displayName = displayName), 
...
#' @export
VideoClassificationAnnotation <- function(type = NULL, timeSegment = NULL, classificationAnnotation = NULL) {
    structure(list(type = type, timeSegment = timeSegment, classificationAnnotation = classificationAnnotation), 
        class = "gar_VideoClassificationAnnotation")
}
...
#' 
#' @param columnSpecIds Input Only
#' @param values Input Only
#' 
#' @return Row object
#' 
#' @family Row functions
#' @export
Row <- function(columnSpecIds = NULL, values = NULL) {
    structure(list(columnSpecIds = columnSpecIds, values = values), class = "gar_Row")
}
...
#' @export
OperationMetadata <- function(undeployModelDetails = NULL, partialFailures = NULL, 
    importDataDetails = NULL, batchPredictDetails = NULL, progressPercent = NULL, 
    deployModelDetails = NULL, exportModelDetails = NULL, deleteDetails = NULL, createModelDetails = NULL, 
    createTime = NULL, updateTime = NULL, exportDataDetails = NULL, exportEvaluatedExamplesDetails = NULL) {
    structure(list(undeployModelDetails = undeployModelDetails, partialFailures = partialFailures, 
        importDataDetails = importDataDetails, batchPredictDetails = batchPredictDetails, 
        progressPercent = progressPercent, deployModelDetails = deployModelDetails, 
        exportModelDetails = exportModelDetails, deleteDetails = deleteDetails, createModelDetails = createModelDetails, 
        createTime = createTime, updateTime = updateTime, exportDataDetails = exportDataDetails, 
        exportEvaluatedExamplesDetails = exportEvaluatedExamplesDetails), class = "gar_OperationMetadata")
}
...
Location <- function(Location.labels = NULL, Location.metadata = NULL, labels = NULL, 
    name = NULL, locationId = NULL, displayName = NULL, metadata = NULL) {
    structure(list(Location.labels = Location.labels, Location.metadata = Location.metadata, 
        labels = labels, name = name, locationId = locationId, displayName = displayName, 
        metadata = metadata), class = "gar_Location")
}
