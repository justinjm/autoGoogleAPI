...
#' @export
TablesModelMetadata <- function(inputFeatureColumnSpecs = NULL, tablesModelColumnInfo = NULL, 
    trainBudgetMilliNodeHours = NULL, targetColumnSpec = NULL, disableEarlyStopping = NULL, 
    trainCostMilliNodeHours = NULL, optimizationObjective = NULL) {
    structure(list(inputFeatureColumnSpecs = inputFeatureColumnSpecs, tablesModelColumnInfo = tablesModelColumnInfo, 
...
AnnotationPayload <- function(translation = NULL, textSentiment = NULL, videoObjectTracking = NULL, 
    tables = NULL, videoClassification = NULL, annotationSpecId = NULL, textExtraction = NULL, 
    classification = NULL, imageObjectDetection = NULL, displayName = NULL) {
    structure(list(translation = translation, textSentiment = textSentiment, videoObjectTracking = videoObjectTracking, 
        tables = tables, videoClassification = videoClassification, annotationSpecId = annotationSpecId, 
...
#' @export
ClassificationEvaluationMetricsConfidenceMetricsEntry <- function(f1Score = NULL, 
    ...
    recallAt1 = NULL, f1ScoreAt1 = NULL, precision = NULL, truePositiveCount = NULL, 
    precisionAt1 = NULL, confidenceThreshold = NULL) {
    structure(list(f1Score = f1Score, trueNegativeCount = trueNegativeCount, positionThreshold = positionThreshold, 
        ...
        precisionAt1 = precisionAt1, confidenceThreshold = confidenceThreshold), 
...
TextExtractionEvaluationMetricsConfidenceMetricsEntry <- function(confidenceThreshold = NULL, 
    ...
    structure(list(confidenceThreshold = confidenceThreshold, recall = recall, f1Score = f1Score, 
        precision = precision), class = "gar_TextExtractionEvaluationMetricsConfidenceMetricsEntry")
}
...
#' @export
Model <- function(textSentimentModelMetadata = NULL, imageObjectDetectionModelMetadata = NULL, 
    ...
    createTime = NULL, imageClassificationModelMetadata = NULL, tablesModelMetadata = NULL, 
    textExtractionModelMetadata = NULL, updateTime = NULL, textClassificationModelMetadata = NULL) {
    structure(list(textSentimentModelMetadata = textSentimentModelMetadata, imageObjectDetectionModelMetadata = imageObjectDetectionModelMetadata, 
...
#' @export
DataType <- function(structType = NULL, timeFormat = NULL, nullable = NULL, listElementType = NULL, 
    typeCode = NULL) {
    structure(list(structType = structType, timeFormat = timeFormat, nullable = nullable, 
        listElementType = listElementType, typeCode = typeCode), class = "gar_DataType")
}
...
#' @export
OperationMetadata <- function(exportEvaluatedExamplesDetails = NULL, undeployModelDetails = NULL, 
    partialFailures = NULL, importDataDetails = NULL, batchPredictDetails = NULL, 
    progressPercent = NULL, deployModelDetails = NULL, exportModelDetails = NULL, 
    deleteDetails = NULL, createModelDetails = NULL, createTime = NULL, updateTime = NULL, 
    exportDataDetails = NULL) {
    structure(list(exportEvaluatedExamplesDetails = exportEvaluatedExamplesDetails, 
...
#' @export
TableSpec <- function(etag = NULL, timeColumnSpecId = NULL, name = NULL, columnCount = NULL, 
    inputConfigs = NULL, rowCount = NULL) {
    structure(list(etag = etag, timeColumnSpecId = timeColumnSpecId, name = name, 
...
Dataset <- function(createTime = NULL, textExtractionDatasetMetadata = NULL, videoClassificationDatasetMetadata = NULL, 
    ...
    textClassificationDatasetMetadata = NULL, displayName = NULL) {
...
#' @export
CorrelatedColumn <- function(columnSpecId = NULL, correlationStats = NULL) {
    structure(list(columnSpecId = columnSpecId, correlationStats = correlationStats), 
...
#' @export
DataStats <- function(validValueCount = NULL, nullValueCount = NULL, timestampStats = NULL, 
    float64Stats = NULL, stringStats = NULL, arrayStats = NULL, structStats = NULL, 
    categoryStats = NULL, distinctValueCount = NULL) {
    structure(list(validValueCount = validValueCount, nullValueCount = nullValueCount, 
        timestampStats = timestampStats, float64Stats = float64Stats, stringStats = stringStats, 
        arrayStats = arrayStats, structStats = structStats, categoryStats = categoryStats, 
        distinctValueCount = distinctValueCount), class = "gar_DataStats")
}
...
ImageObjectDetectionModelMetadata <- function(nodeCount = NULL, modelType = NULL, 
    trainBudgetMilliNodeHours = NULL, stopReason = NULL, nodeQps = NULL, trainCostMilliNodeHours = NULL) {
