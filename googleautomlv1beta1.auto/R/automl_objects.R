...
#' @export
Model <- function(deploymentState = NULL, imageClassificationModelMetadata = NULL, 
    createTime = NULL, tablesModelMetadata = NULL, textExtractionModelMetadata = NULL, 
    updateTime = NULL, textClassificationModelMetadata = NULL, datasetId = NULL, 
    imageObjectDetectionModelMetadata = NULL, textSentimentModelMetadata = NULL, 
    videoObjectTrackingModelMetadata = NULL, name = NULL, translationModelMetadata = NULL, 
    videoClassificationModelMetadata = NULL, displayName = NULL) {
    structure(list(deploymentState = deploymentState, imageClassificationModelMetadata = imageClassificationModelMetadata, 
        ...
        name = name, translationModelMetadata = translationModelMetadata, videoClassificationModelMetadata = videoClassificationModelMetadata, 
...
#' @export
ModelEvaluation <- function(imageObjectDetectionEvaluationMetrics = NULL, annotationSpecId = NULL, 
    textExtractionEvaluationMetrics = NULL, regressionEvaluationMetrics = NULL, name = NULL, 
    evaluatedExampleCount = NULL, textSentimentEvaluationMetrics = NULL, videoObjectTrackingEvaluationMetrics = NULL, 
    translationEvaluationMetrics = NULL, classificationEvaluationMetrics = NULL, 
    displayName = NULL, createTime = NULL) {
    structure(list(imageObjectDetectionEvaluationMetrics = imageObjectDetectionEvaluationMetrics, 
        annotationSpecId = annotationSpecId, textExtractionEvaluationMetrics = textExtractionEvaluationMetrics, 
        regressionEvaluationMetrics = regressionEvaluationMetrics, name = name, evaluatedExampleCount = evaluatedExampleCount, 
        textSentimentEvaluationMetrics = textSentimentEvaluationMetrics, videoObjectTrackingEvaluationMetrics = videoObjectTrackingEvaluationMetrics, 
        translationEvaluationMetrics = translationEvaluationMetrics, classificationEvaluationMetrics = classificationEvaluationMetrics, 
        displayName = displayName, createTime = createTime), class = "gar_ModelEvaluation")
}
...
#' @export
OperationMetadata <- function(deleteDetails = NULL, exportModelDetails = NULL, createModelDetails = NULL, 
    createTime = NULL, exportDataDetails = NULL, updateTime = NULL, exportEvaluatedExamplesDetails = NULL, 
    undeployModelDetails = NULL, partialFailures = NULL, importDataDetails = NULL, 
    batchPredictDetails = NULL, progressPercent = NULL, deployModelDetails = NULL) {
    structure(list(deleteDetails = deleteDetails, exportModelDetails = exportModelDetails, 
        createModelDetails = createModelDetails, createTime = createTime, exportDataDetails = exportDataDetails, 
        updateTime = updateTime, exportEvaluatedExamplesDetails = exportEvaluatedExamplesDetails, 
...
Dataset <- function(description = NULL, imageClassificationDatasetMetadata = NULL, 
    ...
    structure(list(description = description, imageClassificationDatasetMetadata = imageClassificationDatasetMetadata, 
        ...
        textClassificationDatasetMetadata = textClassificationDatasetMetadata, displayName = displayName, 
...
#' @export
ColumnSpec <- function(dataType = NULL, name = NULL, topCorrelatedColumns = NULL, 
    dataStats = NULL, displayName = NULL, etag = NULL) {
    structure(list(dataType = dataType, name = name, topCorrelatedColumns = topCorrelatedColumns, 
        dataStats = dataStats, displayName = displayName, etag = etag), class = "gar_ColumnSpec")
}
...
#' @export
TextSegment <- function(content = NULL, endOffset = NULL, startOffset = NULL) {
    structure(list(content = content, endOffset = endOffset, startOffset = startOffset), 
...
#' @export
DataStats <- function(nullValueCount = NULL, float64Stats = NULL, timestampStats = NULL, 
    arrayStats = NULL, stringStats = NULL, structStats = NULL, categoryStats = NULL, 
    distinctValueCount = NULL, validValueCount = NULL) {
    structure(list(nullValueCount = nullValueCount, float64Stats = float64Stats, 
        timestampStats = timestampStats, arrayStats = arrayStats, stringStats = stringStats, 
        structStats = structStats, categoryStats = categoryStats, distinctValueCount = distinctValueCount, 
        validValueCount = validValueCount), class = "gar_DataStats")
}
...
ImageObjectDetectionModelMetadata <- function(modelType = NULL, trainBudgetMilliNodeHours = NULL, 
    stopReason = NULL, trainCostMilliNodeHours = NULL, nodeQps = NULL, nodeCount = NULL) {
    structure(list(modelType = modelType, trainBudgetMilliNodeHours = trainBudgetMilliNodeHours, 
        ...
        nodeQps = nodeQps, nodeCount = nodeCount), class = "gar_ImageObjectDetectionModelMetadata")
}
...
BatchPredictRequest <- function(BatchPredictRequest.params = NULL, inputConfig = NULL, 
    ...
    structure(list(BatchPredictRequest.params = BatchPredictRequest.params, inputConfig = inputConfig, 
        outputConfig = outputConfig, params = params), class = "gar_BatchPredictRequest")
}
...
#' @export
TablesModelMetadata <- function(trainBudgetMilliNodeHours = NULL, targetColumnSpec = NULL, 
    disableEarlyStopping = NULL, trainCostMilliNodeHours = NULL, optimizationObjective = NULL, 
    inputFeatureColumnSpecs = NULL, tablesModelColumnInfo = NULL) {
    structure(list(trainBudgetMilliNodeHours = trainBudgetMilliNodeHours, targetColumnSpec = targetColumnSpec, 
        disableEarlyStopping = disableEarlyStopping, trainCostMilliNodeHours = trainCostMilliNodeHours, 
        optimizationObjective = optimizationObjective, inputFeatureColumnSpecs = inputFeatureColumnSpecs, 
        tablesModelColumnInfo = tablesModelColumnInfo), class = "gar_TablesModelMetadata")
}
...
TextSentimentEvaluationMetrics <- function(annotationSpecId = NULL, linearKappa = NULL, 
    f1Score = NULL, precision = NULL, meanSquaredError = NULL, confusionMatrix = NULL, 
...
#' @export
TablesModelColumnInfo <- function(columnDisplayName = NULL, columnSpecName = NULL, 
    featureImportance = NULL) {
    structure(list(columnDisplayName = columnDisplayName, columnSpecName = columnSpecName, 
        featureImportance = featureImportance), class = "gar_TablesModelColumnInfo")
}
...
ClassificationEvaluationMetricsConfidenceMetricsEntry <- function(f1ScoreAt1 = NULL, 
    precision = NULL, truePositiveCount = NULL, precisionAt1 = NULL, confidenceThreshold = NULL, 
    f1Score = NULL, positionThreshold = NULL, trueNegativeCount = NULL, falseNegativeCount = NULL, 
    falsePositiveCount = NULL, falsePositiveRate = NULL, recall = NULL, falsePositiveRateAt1 = NULL, 
    recallAt1 = NULL) {
    structure(list(f1ScoreAt1 = f1ScoreAt1, precision = precision, truePositiveCount = truePositiveCount, 
        precisionAt1 = precisionAt1, confidenceThreshold = confidenceThreshold, f1Score = f1Score, 
        positionThreshold = positionThreshold, trueNegativeCount = trueNegativeCount, 
