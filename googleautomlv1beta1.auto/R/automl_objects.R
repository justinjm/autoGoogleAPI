...
#'  at 2019-11-04 14:55:26
#' filename: /Users/justinmarciszewski/Dropbox/dev/R/autoGoogleAPI/googleautomlv1beta1.auto/R/automl_objects.R
#' api_json: api_json
#' 
...
#' @export
TableSpec <- function(timeColumnSpecId = NULL, name = NULL, columnCount = NULL, inputConfigs = NULL, 
    rowCount = NULL, validRowCount = NULL, etag = NULL) {
    structure(list(timeColumnSpecId = timeColumnSpecId, name = name, columnCount = columnCount, 
        inputConfigs = inputConfigs, rowCount = rowCount, validRowCount = validRowCount, 
        etag = etag), class = "gar_TableSpec")
}
...
#' @export
Dataset <- function(videoObjectTrackingDatasetMetadata = NULL, displayName = NULL, 
    textClassificationDatasetMetadata = NULL, createTime = NULL, textExtractionDatasetMetadata = NULL, 
    videoClassificationDatasetMetadata = NULL, tablesDatasetMetadata = NULL, description = NULL, 
    imageClassificationDatasetMetadata = NULL, etag = NULL, textSentimentDatasetMetadata = NULL, 
    name = NULL, imageObjectDetectionDatasetMetadata = NULL, translationDatasetMetadata = NULL, 
    exampleCount = NULL) {
    structure(list(videoObjectTrackingDatasetMetadata = videoObjectTrackingDatasetMetadata, 
...
#' @export
ColumnSpec <- function(topCorrelatedColumns = NULL, dataStats = NULL, displayName = NULL, 
    etag = NULL, dataType = NULL, name = NULL) {
    structure(list(topCorrelatedColumns = topCorrelatedColumns, dataStats = dataStats, 
        displayName = displayName, etag = etag, dataType = dataType, name = name), 
...
PredictResponse <- function(PredictResponse.metadata = NULL, metadata = NULL, payload = NULL, 
    ...
    structure(list(PredictResponse.metadata = PredictResponse.metadata, metadata = metadata, 
        payload = payload, preprocessedInput = preprocessedInput), class = "gar_PredictResponse")
}
...
TablesAnnotation <- function(score = NULL, predictionInterval = NULL, value = NULL, 
    tablesModelColumnInfo = NULL) {
    structure(list(score = score, predictionInterval = predictionInterval, value = value, 
        tablesModelColumnInfo = tablesModelColumnInfo), class = "gar_TablesAnnotation")
}
...
#' @export
ImageClassificationModelMetadata <- function(stopReason = NULL, trainCost = NULL, 
    nodeQps = NULL, trainBudget = NULL, nodeCount = NULL, baseModelId = NULL, modelType = NULL) {
    structure(list(stopReason = stopReason, trainCost = trainCost, nodeQps = nodeQps, 
        trainBudget = trainBudget, nodeCount = nodeCount, baseModelId = baseModelId, 
...
#' @export
ImageObjectDetectionModelMetadata <- function(stopReason = NULL, trainCostMilliNodeHours = NULL, 
    nodeQps = NULL, nodeCount = NULL, modelType = NULL, trainBudgetMilliNodeHours = NULL) {
    structure(list(stopReason = stopReason, trainCostMilliNodeHours = trainCostMilliNodeHours, 
        nodeQps = nodeQps, nodeCount = nodeCount, modelType = modelType, trainBudgetMilliNodeHours = trainBudgetMilliNodeHours), 
...
TablesModelMetadata <- function(tablesModelColumnInfo = NULL, inputFeatureColumnSpecs = NULL, 
    trainBudgetMilliNodeHours = NULL, targetColumnSpec = NULL, optimizationObjectiveRecallValue = NULL, 
    trainCostMilliNodeHours = NULL, disableEarlyStopping = NULL, optimizationObjective = NULL, 
    optimizationObjectivePrecisionValue = NULL) {
    structure(list(tablesModelColumnInfo = tablesModelColumnInfo, inputFeatureColumnSpecs = inputFeatureColumnSpecs, 
        ...
        optimizationObjectiveRecallValue = optimizationObjectiveRecallValue, trainCostMilliNodeHours = trainCostMilliNodeHours, 
...
#' @export
RegressionEvaluationMetrics <- function(rootMeanSquaredLogError = NULL, meanAbsoluteError = NULL, 
    meanAbsolutePercentageError = NULL, rSquared = NULL, rootMeanSquaredError = NULL) {
    structure(list(rootMeanSquaredLogError = rootMeanSquaredLogError, meanAbsoluteError = meanAbsoluteError, 
        ...
        rootMeanSquaredError = rootMeanSquaredError), class = "gar_RegressionEvaluationMetrics")
}
...
#' @export
AnnotationPayload <- function(videoObjectTracking = NULL, tables = NULL, videoClassification = NULL, 
    annotationSpecId = NULL, classification = NULL, textExtraction = NULL, imageObjectDetection = NULL, 
    displayName = NULL, textSentiment = NULL, translation = NULL) {
    structure(list(videoObjectTracking = videoObjectTracking, tables = tables, videoClassification = videoClassification, 
        annotationSpecId = annotationSpecId, classification = classification, textExtraction = textExtraction, 
        imageObjectDetection = imageObjectDetection, displayName = displayName, textSentiment = textSentiment, 
        translation = translation), class = "gar_AnnotationPayload")
}
...
#' @export
TextSentimentEvaluationMetrics <- function(recall = NULL, annotationSpecId = NULL, 
    linearKappa = NULL, f1Score = NULL, precision = NULL, meanSquaredError = NULL, 
    confusionMatrix = NULL, quadraticKappa = NULL, meanAbsoluteError = NULL) {
    structure(list(recall = recall, annotationSpecId = annotationSpecId, linearKappa = linearKappa, 
        f1Score = f1Score, precision = precision, meanSquaredError = meanSquaredError, 
...
#' @export
Model <- function(translationModelMetadata = NULL, name = NULL, videoClassificationModelMetadata = NULL, 
    displayName = NULL, deploymentState = NULL, imageClassificationModelMetadata = NULL, 
    createTime = NULL, tablesModelMetadata = NULL, textExtractionModelMetadata = NULL, 
    updateTime = NULL, textClassificationModelMetadata = NULL, textSentimentModelMetadata = NULL, 
    imageObjectDetectionModelMetadata = NULL, datasetId = NULL, videoObjectTrackingModelMetadata = NULL) {
    structure(list(translationModelMetadata = translationModelMetadata, name = name, 
        ...
        createTime = createTime, tablesModelMetadata = tablesModelMetadata, textExtractionModelMetadata = textExtractionModelMetadata, 
...
#' @export
ExamplePayload <- function(image = NULL, row = NULL, textSnippet = NULL, document = NULL) {
    structure(list(image = image, row = row, textSnippet = textSnippet, document = document), 
...
#' @export
ModelEvaluation <- function(regressionEvaluationMetrics = NULL, evaluatedExampleCount = NULL, 
    ...
    createTime = NULL, annotationSpecId = NULL, imageObjectDetectionEvaluationMetrics = NULL, 
    textExtractionEvaluationMetrics = NULL) {
    structure(list(regressionEvaluationMetrics = regressionEvaluationMetrics, evaluatedExampleCount = evaluatedExampleCount, 
        name = name, videoObjectTrackingEvaluationMetrics = videoObjectTrackingEvaluationMetrics, 
        ...
        createTime = createTime, annotationSpecId = annotationSpecId, imageObjectDetectionEvaluationMetrics = imageObjectDetectionEvaluationMetrics, 
...
OperationMetadata <- function(progressPercent = NULL, deployModelDetails = NULL, 
    ...
    updateTime = NULL, exportDataDetails = NULL, exportEvaluatedExamplesDetails = NULL, 
