...
AnnotationPayload <- function(annotationSpecId = NULL, textExtraction = NULL, classification = NULL, 
    ...
    structure(list(annotationSpecId = annotationSpecId, textExtraction = textExtraction, 
        classification = classification, imageObjectDetection = imageObjectDetection, 
...
#' @export
Dataset <- function(Dataset.labels = NULL, createTime = NULL, labels = NULL, textExtractionDatasetMetadata = NULL, 
    description = NULL, imageClassificationDatasetMetadata = NULL, etag = NULL, textSentimentDatasetMetadata = NULL, 
    name = NULL, imageObjectDetectionDatasetMetadata = NULL, translationDatasetMetadata = NULL, 
    exampleCount = NULL, displayName = NULL, textClassificationDatasetMetadata = NULL) {
    structure(list(Dataset.labels = Dataset.labels, createTime = createTime, labels = labels, 
        textExtractionDatasetMetadata = textExtractionDatasetMetadata, description = description, 
...
#' @export
TextSentimentEvaluationMetrics <- function(f1Score = NULL, meanSquaredError = NULL, 
    precision = NULL, confusionMatrix = NULL, quadraticKappa = NULL, meanAbsoluteError = NULL, 
    recall = NULL, linearKappa = NULL) {
    structure(list(f1Score = f1Score, meanSquaredError = meanSquaredError, precision = precision, 
        confusionMatrix = confusionMatrix, quadraticKappa = quadraticKappa, meanAbsoluteError = meanAbsoluteError, 
        recall = recall, linearKappa = linearKappa), class = "gar_TextSentimentEvaluationMetrics")
}
...
#' @export
ClassificationEvaluationMetricsConfidenceMetricsEntry <- function(falsePositiveRate = NULL, 
    recall = NULL, falsePositiveRateAt1 = NULL, recallAt1 = NULL, f1ScoreAt1 = NULL, 
    precision = NULL, truePositiveCount = NULL, confidenceThreshold = NULL, precisionAt1 = NULL, 
    f1Score = NULL, trueNegativeCount = NULL, positionThreshold = NULL, falseNegativeCount = NULL, 
    falsePositiveCount = NULL) {
    structure(list(falsePositiveRate = falsePositiveRate, recall = recall, falsePositiveRateAt1 = falsePositiveRateAt1, 
...
#' @export
ConfusionMatrix <- function(annotationSpecId = NULL, row = NULL, displayName = NULL) {
    structure(list(annotationSpecId = annotationSpecId, row = row, displayName = displayName), 
...
#' @export
Model <- function(Model.labels = NULL, deploymentState = NULL, labels = NULL, imageClassificationModelMetadata = NULL, 
    createTime = NULL, updateTime = NULL, textExtractionModelMetadata = NULL, textClassificationModelMetadata = NULL, 
    etag = NULL, datasetId = NULL, textSentimentModelMetadata = NULL, imageObjectDetectionModelMetadata = NULL, 
    translationModelMetadata = NULL, name = NULL, displayName = NULL) {
    structure(list(Model.labels = Model.labels, deploymentState = deploymentState, 
        labels = labels, imageClassificationModelMetadata = imageClassificationModelMetadata, 
        ...
        datasetId = datasetId, textSentimentModelMetadata = textSentimentModelMetadata, 
        imageObjectDetectionModelMetadata = imageObjectDetectionModelMetadata, translationModelMetadata = translationModelMetadata, 
        name = name, displayName = displayName), class = "gar_Model")
}
...
DocumentDimensions <- function(unit = NULL, height = NULL, width = NULL) {
    structure(list(unit = unit, height = height, width = width), class = "gar_DocumentDimensions")
}
...
ModelEvaluation <- function(imageObjectDetectionEvaluationMetrics = NULL, annotationSpecId = NULL, 
    translationEvaluationMetrics = NULL, textExtractionEvaluationMetrics = NULL, 
    classificationEvaluationMetrics = NULL, displayName = NULL, createTime = NULL, 
    evaluatedExampleCount = NULL, name = NULL, textSentimentEvaluationMetrics = NULL) {
    structure(list(imageObjectDetectionEvaluationMetrics = imageObjectDetectionEvaluationMetrics, 
        annotationSpecId = annotationSpecId, translationEvaluationMetrics = translationEvaluationMetrics, 
        textExtractionEvaluationMetrics = textExtractionEvaluationMetrics, classificationEvaluationMetrics = classificationEvaluationMetrics, 
        displayName = displayName, createTime = createTime, evaluatedExampleCount = evaluatedExampleCount, 
        name = name, textSentimentEvaluationMetrics = textSentimentEvaluationMetrics), 
...
#' @export
Document <- function(layout = NULL, pageCount = NULL, documentDimensions = NULL, 
    inputConfig = NULL, documentText = NULL) {
    structure(list(layout = layout, pageCount = pageCount, documentDimensions = documentDimensions, 
        inputConfig = inputConfig, documentText = documentText), class = "gar_Document")
}
...
#' @export
OperationMetadata <- function(createDatasetDetails = NULL, undeployModelDetails = NULL, 
    partialFailures = NULL, importDataDetails = NULL, batchPredictDetails = NULL, 
    progressPercent = NULL, deployModelDetails = NULL, deleteDetails = NULL, exportModelDetails = NULL, 
    createModelDetails = NULL, createTime = NULL, exportDataDetails = NULL, updateTime = NULL) {
    structure(list(createDatasetDetails = createDatasetDetails, undeployModelDetails = undeployModelDetails, 
        partialFailures = partialFailures, importDataDetails = importDataDetails, 
        batchPredictDetails = batchPredictDetails, progressPercent = progressPercent, 
        ...
        updateTime = updateTime), class = "gar_OperationMetadata")
}
...
#' @export
ImageClassificationModelMetadata <- function(nodeCount = NULL, baseModelId = NULL, 
    modelType = NULL, trainBudgetMilliNodeHours = NULL, stopReason = NULL, trainCostMilliNodeHours = NULL, 
    nodeQps = NULL) {
    structure(list(nodeCount = nodeCount, baseModelId = baseModelId, modelType = modelType, 
        trainBudgetMilliNodeHours = trainBudgetMilliNodeHours, stopReason = stopReason, 
        trainCostMilliNodeHours = trainCostMilliNodeHours, nodeQps = nodeQps), class = "gar_ImageClassificationModelMetadata")
}
...
#' @export
TextSnippet <- function(mimeType = NULL, content = NULL, contentUri = NULL) {
    structure(list(mimeType = mimeType, content = content, contentUri = contentUri), 
