...
#' @export
AnnotationPayload <- function(classification = NULL, textExtraction = NULL, imageObjectDetection = NULL, 
    displayName = NULL, textSentiment = NULL, translation = NULL, annotationSpecId = NULL) {
    structure(list(classification = classification, textExtraction = textExtraction, 
        imageObjectDetection = imageObjectDetection, displayName = displayName, textSentiment = textSentiment, 
        translation = translation, annotationSpecId = annotationSpecId), class = "gar_AnnotationPayload")
}
...
#' @export
TextSentimentEvaluationMetrics <- function(linearKappa = NULL, f1Score = NULL, meanSquaredError = NULL, 
    precision = NULL, confusionMatrix = NULL, quadraticKappa = NULL, meanAbsoluteError = NULL, 
    recall = NULL) {
    structure(list(linearKappa = linearKappa, f1Score = f1Score, meanSquaredError = meanSquaredError, 
        precision = precision, confusionMatrix = confusionMatrix, quadraticKappa = quadraticKappa, 
        meanAbsoluteError = meanAbsoluteError, recall = recall), class = "gar_TextSentimentEvaluationMetrics")
}
...
#' @export
Model <- function(Model.labels = NULL, translationModelMetadata = NULL, name = NULL, 
    displayName = NULL, deploymentState = NULL, createTime = NULL, imageClassificationModelMetadata = NULL, 
    labels = NULL, updateTime = NULL, textExtractionModelMetadata = NULL, textClassificationModelMetadata = NULL, 
    etag = NULL, imageObjectDetectionModelMetadata = NULL, textSentimentModelMetadata = NULL, 
    datasetId = NULL) {
    structure(list(Model.labels = Model.labels, translationModelMetadata = translationModelMetadata, 
        name = name, displayName = displayName, deploymentState = deploymentState, 
        createTime = createTime, imageClassificationModelMetadata = imageClassificationModelMetadata, 
        labels = labels, updateTime = updateTime, textExtractionModelMetadata = textExtractionModelMetadata, 
...
#' @export
DocumentDimensions <- function(width = NULL, unit = NULL, height = NULL) {
    structure(list(width = width, unit = unit, height = height), class = "gar_DocumentDimensions")
}
...
ModelEvaluation <- function(displayName = NULL, classificationEvaluationMetrics = NULL, 
    createTime = NULL, name = NULL, evaluatedExampleCount = NULL, textSentimentEvaluationMetrics = NULL, 
    imageObjectDetectionEvaluationMetrics = NULL, translationEvaluationMetrics = NULL, 
    annotationSpecId = NULL, textExtractionEvaluationMetrics = NULL) {
    structure(list(displayName = displayName, classificationEvaluationMetrics = classificationEvaluationMetrics, 
        createTime = createTime, name = name, evaluatedExampleCount = evaluatedExampleCount, 
        textSentimentEvaluationMetrics = textSentimentEvaluationMetrics, imageObjectDetectionEvaluationMetrics = imageObjectDetectionEvaluationMetrics, 
...
OperationMetadata <- function(progressPercent = NULL, deployModelDetails = NULL, 
    ...
    exportDataDetails = NULL, updateTime = NULL, createDatasetDetails = NULL, undeployModelDetails = NULL, 
    ...
    structure(list(progressPercent = progressPercent, deployModelDetails = deployModelDetails, 
        ...
        createDatasetDetails = createDatasetDetails, undeployModelDetails = undeployModelDetails, 
...
#' @export
ImageClassificationModelMetadata <- function(nodeQps = NULL, trainCostMilliNodeHours = NULL, 
    nodeCount = NULL, baseModelId = NULL, modelType = NULL, trainBudgetMilliNodeHours = NULL, 
    stopReason = NULL) {
    structure(list(nodeQps = nodeQps, trainCostMilliNodeHours = trainCostMilliNodeHours, 
        nodeCount = nodeCount, baseModelId = baseModelId, modelType = modelType, 
